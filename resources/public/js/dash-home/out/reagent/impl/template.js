...
var G__1621 = o;
(G__1621[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__1622__delegate = function (args){
...
while (G__1623__i < G__1623__a.length) {G__1623__a[G__1623__i] = arguments[G__1623__i + 0]; ++G__1623__i;}
  args = new cljs.core.IndexedSeq(G__1623__a,0,null);
} 
return G__1622__delegate.call(this,args);};
G__1622.cljs$lang$maxFixedArity = 0;
G__1622.cljs$lang$applyTo = (function (arglist__1624){
var args = cljs.core.seq(arglist__1624);
return G__1622__delegate(args);
});
...
var G__1625 = o;
(G__1625[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__1630 = props;
var G__1630__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__1630,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__1630);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1630__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__1631){
...
var props = map__1632__$1;
var class$ = cljs.core.get.call(null,map__1632__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__1632,map__1632__$1,props,class$){
return (function (c){
...
});})(map__1632,map__1632__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__1634){
...
var on_write = cljs.core.get.call(null,map__1635__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__1635,map__1635__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__1635,map__1635__$1,on_write))
);
} else {
...
var G__1638 = jsprops;
(G__1638["defaultValue"] = value);

(G__1638["onChange"] = ((function (G__1638,v,value,on_change){
return (function (p1__1637_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__1637_SHARP_);
});})(G__1638,v,value,on_change))
);
...
var vec__1641 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__1641,(0),null);
var id = cljs.core.nth.call(null,vec__1641,(1),null);
var class$ = cljs.core.nth.call(null,vec__1641,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___1645 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___1645 == null)){
} else {
var key_1646 = temp__4661__auto___1645;
(jsprops["key"] = key_1646);
}
...
var temp__4661__auto___1647 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___1647 == null)){
} else {
var key_1648 = temp__4661__auto___1647;
reagent.impl.template.oset.call(null,jsprops,"key",key_1648);
}
...
var G__1649 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__1649["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq1652){
var G__1653 = cljs.core.first.call(null,seq1652);
var seq1652__$1 = cljs.core.next.call(null,seq1652);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1653,seq1652__$1);
});
...
break;
default:
var G__1659 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__1659;
continue;
...
var n__4376__auto___1661 = a.length;
var i_1662 = (0);
while(true){
if((i_1662 < n__4376__auto___1661)){
(a[i_1662] = reagent.impl.template.as_element.call(null,(a[i_1662])));

var G__1663 = (i_1662 + (1));
i_1662 = G__1663;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___1664 = a.length;
var i_1665 = (0);
while(true){
if((i_1665 < n__4376__auto___1664)){
var val_1666 = (a[i_1665]);
if(((cljs.core.vector_QMARK_.call(null,val_1666)) && ((reagent.impl.template.key_from_vec.call(null,val_1666) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_1665] = reagent.impl.template.as_element.call(null,val_1666));

var G__1667 = (i_1665 + (1));
i_1665 = G__1667;
continue;
} else {
}
...
var ctx = ({});
var vec__1668 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__1668,(0),null);
var derefed = cljs.core.nth.call(null,vec__1668,(1),null);
...
var G__1671 = (cljs.core.count.call(null,argv) - first_child);
switch (G__1671) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__1671){
