...
var G__2535 = o;
(G__2535[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__2539 = o;
(G__2539[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__2541__i = 0, G__2541__a = new Array(arguments.length -  0);
while (G__2541__i < G__2541__a.length) {G__2541__a[G__2541__i] = arguments[G__2541__i + 0]; ++G__2541__i;}
  args = new cljs.core.IndexedSeq(G__2541__a,0,null);
} 
...
var G__2544 = props;
var G__2544__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2544,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2544);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2544__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__2545){
var map__2546 = p__2545;
var map__2546__$1 = ((((!((map__2546 == null)))?(((((map__2546.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2546.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2546):map__2546);
var props = map__2546__$1;
var class$ = cljs.core.get.call(null,map__2546__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__2546,map__2546__$1,props,class$){
return (function (c){
...
});})(map__2546,map__2546__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__2548){
var map__2549 = p__2548;
var map__2549__$1 = ((((!((map__2549 == null)))?(((((map__2549.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2549.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2549):map__2549);
var on_write = cljs.core.get.call(null,map__2549__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__2549,map__2549__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__2549,map__2549__$1,on_write))
);
} else {
...
var G__2552 = jsprops;
(G__2552["defaultValue"] = value);

(G__2552["onChange"] = ((function (G__2552,v,value,on_change){
return (function (p1__2551_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__2551_SHARP_);
});})(G__2552,v,value,on_change))
);
...
var vec__2555 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2555,(0),null);
var id = cljs.core.nth.call(null,vec__2555,(1),null);
var class$ = cljs.core.nth.call(null,vec__2555,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___2559 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___2559 == null)){
} else {
var key_2560 = temp__4661__auto___2559;
(jsprops["key"] = key_2560);
}
...
var temp__4661__auto___2561 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___2561 == null)){
} else {
var key_2562 = temp__4661__auto___2561;
reagent.impl.template.oset.call(null,jsprops,"key",key_2562);
}
...
var G__2563 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__2563["name"] = c);
...
var len__4499__auto___2568 = arguments.length;
var i__4500__auto___2569 = (0);
while(true){
if((i__4500__auto___2569 < len__4499__auto___2568)){
args__4502__auto__.push((arguments[i__4500__auto___2569]));

var G__2570 = (i__4500__auto___2569 + (1));
i__4500__auto___2569 = G__2570;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq2566){
var G__2567 = cljs.core.first.call(null,seq2566);
var seq2566__$1 = cljs.core.next.call(null,seq2566);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2567,seq2566__$1);
});
...
break;
default:
var G__2573 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__2573;
continue;
...
var n__4376__auto___2575 = a.length;
var i_2576 = (0);
while(true){
if((i_2576 < n__4376__auto___2575)){
(a[i_2576] = reagent.impl.template.as_element.call(null,(a[i_2576])));

var G__2577 = (i_2576 + (1));
i_2576 = G__2577;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___2578 = a.length;
var i_2579 = (0);
while(true){
if((i_2579 < n__4376__auto___2578)){
var val_2580 = (a[i_2579]);
if(((cljs.core.vector_QMARK_.call(null,val_2580)) && ((reagent.impl.template.key_from_vec.call(null,val_2580) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_2579] = reagent.impl.template.as_element.call(null,val_2580));

var G__2581 = (i_2579 + (1));
i_2579 = G__2581;
continue;
} else {
}
...
var ctx = ({});
var vec__2582 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__2582,(0),null);
var derefed = cljs.core.nth.call(null,vec__2582,(1),null);
...
var G__2585 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2585) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__2585){
