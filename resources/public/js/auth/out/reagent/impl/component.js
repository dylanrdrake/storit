...
if((i < len)){
var k = (ks[i]);
var G__2474 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__2475 = (i + (1));
m = G__2474;
i = G__2475;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__2477 = c;
var G__2477__$1 = (((G__2477 == null))?null:G__2477.prototype);
if((G__2477__$1 == null)){
return null;
} else {
return (G__2477__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__2479 = c;
var G__2479__$1 = (((G__2479 == null))?null:G__2479.prototype);
if((G__2479__$1 == null)){
return null;
} else {
return (G__2479__$1["render"]);
}
})() == null))));
});
...
var G__2483__i = 0, G__2483__a = new Array(arguments.length -  0);
while (G__2483__i < G__2483__a.length) {G__2483__a[G__2483__i] = arguments[G__2483__i + 0]; ++G__2483__i;}
  args = new cljs.core.IndexedSeq(G__2483__a,0,null);
} 
return G__2482__delegate.call(this,args);};
G__2482.cljs$lang$maxFixedArity = 0;
G__2482.cljs$lang$applyTo = (function (arglist__2484){
var args = cljs.core.seq(arglist__2484);
return G__2482__delegate(args);
});
G__2482.cljs$core$IFn$_invoke$arity$variadic = G__2482__delegate;
return G__2482;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_2486 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_2486;
}});
...
var G__2487 = key;
var G__2487__$1 = (((G__2487 instanceof cljs.core.Keyword))?G__2487.fqn:null);
switch (G__2487__$1) {
...
return ((function (G__2487,G__2487__$1){
...
var c = this;
var G__2492_2494 = (c["cljsRatom"]);
if((G__2492_2494 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__2492_2494);
}
...
var renders_2496 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_2497 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_2496));
if((cljs.core.count.call(null,renders_2496) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_2496))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_2497)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_2497))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__2495 = name;
switch (G__2495) {
case "":
...
var G__2499 = o;
(G__2499[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__2500 = fiber;
var G__2500__$1 = (((G__2500 == null))?null:(G__2500["type"]));
if((G__2500__$1 == null)){
return null;
} else {
return (G__2500__$1["displayName"]);
}
})();
var parent = (function (){var G__2501 = fiber;
if((G__2501 == null)){
return null;
} else {
return (G__2501["return"]);
}
})();
var path = (function (){var G__2502 = parent;
var G__2502__$1 = (((G__2502 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__2502));
if((G__2502__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2502__$1)," > "].join('');
}
})();
...
var temp__4655__auto__ = (function (){var or__3922__auto__ = (function (){var G__2504 = c;
if((G__2504 == null)){
return null;
} else {
return (G__2504["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__2505._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__2507 = c;
if((G__2507 == null)){
return null;
} else {
return (G__2507["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__2509 = c;
if((G__2509 == null)){
return null;
} else {
return G__2509._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__2511 = instance;
if((G__2511 == null)){
return null;
} else {
return (G__2511["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__2512 = instance;
if((G__2512 == null)){
return null;
} else {
return G__2512._currentElement;
}
}
})();
var name = (function (){var G__2513 = elem;
var G__2513__$1 = (((G__2513 == null))?null:(G__2513["type"]));
if((G__2513__$1 == null)){
return null;
} else {
return (G__2513__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__2515 = elem;
if((G__2515 == null)){
return null;
} else {
return (G__2515["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__2516._owner;
}
}
})();
var path = (function (){var G__2517 = owner;
var G__2517__$1 = (((G__2517 == null))?null:reagent.impl.component.component_path.call(null,G__2517));
if((G__2517__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2517__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__2518 = c;
var G__2518__$1 = (((G__2518 == null))?null:G__2518.constructor);
if((G__2518__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__2518__$1);
}
}
})();
