...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__834 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__834,ch);
...
var vec__844 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__844,(0),null);
var start_column = cljs.core.nth.call(null,vec__844,(1),null);
...
var G__847 = cljs.core.conj_BANG_.call(null,a,form);
a = G__847;
continue;
}
}
...
var _STAR_read_delim_STAR_848 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_848;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__849 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__849,(0),null);
var start_column = cljs.core.nth.call(null,vec__849,(1),null);
...
var vec__852 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__852,(0),null);
var end_column = cljs.core.nth.call(null,vec__852,(1),null);
...
var vec__855 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__855,(0),null);
var start_column = cljs.core.nth.call(null,vec__855,(1),null);
...
var vec__858 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__858,(0),null);
var end_column = cljs.core.nth.call(null,vec__858,(1),null);
...
var vec__861 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__861,(0),null);
var start_column = cljs.core.nth.call(null,vec__861,(1),null);
...
var vec__864 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__864,(0),null);
var end_column = cljs.core.nth.call(null,vec__864,(1),null);
...
var sb = (function (){var G__867 = (new goog.string.StringBuffer());
G__867.append(initch);
...
var G__869 = (function (){var G__868 = sb;
G__868.append(ch);

return G__868;
})();
var G__870 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__869;
ch = G__870;
continue;
}
...
switch (G__873) {
case "\\":
var G__877 = (function (){var G__874 = sb;
G__874.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__874;
})();
var G__878 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__877;
ch = G__878;
continue;
...
break;
default:
var G__879 = (function (){var G__875 = sb;
G__875.append(ch);

return G__875;
})();
var G__880 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__879;
ch = G__880;
continue;
...
var vec__881 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__881,(0),null);
var end_column = cljs.core.nth.call(null,vec__881,(1),null);
...
var vec__884 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__884,(0),null);
var column = cljs.core.nth.call(null,vec__884,(1),null);
...
var line = cljs.core.nth.call(null,vec__889,(0),null);
var column = cljs.core.nth.call(null,vec__889,(1),null);
...
var vec__894 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__894,(0),null);
var column = cljs.core.nth.call(null,vec__894,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__899 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__899,(0),null);
var start_column = cljs.core.nth.call(null,vec__899,(1),null);
...
var vec__902 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__902,(0),null);
var end_column = cljs.core.nth.call(null,vec__902,(1),null);
...
var G__905 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__905,true,null,opts,pending_forms);
...
var G__906 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__906)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__906)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__906)){
...
var _STAR_suppress_read_STAR_907 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_907;
}});
...
var G__908 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__908,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__908,rdr,first_line);
...
var G__912 = matched;
var G__913 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__912;
finished = G__913;
continue;
} else {
...
var _STAR_suppress_read_STAR_914 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_914;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env915 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__916 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__916,"(");
...
var G__917 = (i + (1));
var G__918 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env915;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__919 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__919);
...
var G__920 = cljs.core.next.call(null,s__$1);
var G__921 = ret;
s__$1 = G__920;
r = G__921;
continue;
...
var G__922 = cljs.core.next.call(null,s);
var G__923 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__922;
key_vals = G__923;
continue;
} else {
...
var gensym_env927 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env927;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__928 = token;
var G__928__$1 = (((G__928 == null))?null:cljs.core.subs.call(null,G__928,(1)));
var G__928__$2 = (((G__928__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__928__$1));
var G__928__$3 = (((G__928__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__928__$2));
var G__928__$4 = (((G__928__$3 == null))?null:cljs.core.symbol.call(null,G__928__$3));
if((G__928__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__928__$4);
}
})():(function (){var G__929 = token;
var G__929__$1 = (((G__929 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__929));
if((G__929__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__929__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e936){if((e936 instanceof Error)){
var e = e936;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__940,reader){
var map__941 = p__940;
...
var opts = map__941__$1;
var eof = cljs.core.get.call(null,map__941__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___949 = arguments.length;
var i__4500__auto___950 = (0);
while(true){
if((i__4500__auto___950 < len__4499__auto___949)){
args__4502__auto__.push((arguments[i__4500__auto___950]));

var G__951 = (i__4500__auto___950 + (1));
i__4500__auto___950 = G__951;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq947){
var G__948 = cljs.core.first.call(null,seq947);
var seq947__$1 = cljs.core.next.call(null,seq947);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__948,seq947__$1);
});
